...
%Just adding three citations~\citep{Scarton2018} to generate a short References list~\cite[p.~215]{Tani2022}. This is a citation intergrated in text:~\citet{Alva-Manchego2021}.

%====================
% BibLaTex setup 
%Just adding three citation~\autocite{Scarton2018} to generate a short References list~\textcite[p.~215]{Tani2022}. This is a citation intergrated in text: \textcite{Alva-Manchego2021} demonstrated that $\dots$. 

\bigskip

NB! If you are moving between BibTex and BibLaTex, do delete the temporary files and compile several times before despairing. 
